...
#[derive(Error, Debug)]
pub enum DisasmError<ArchError: std::error::Error> {
...
impl<E: std::error::Error + IntoResponse> IntoResponse for DisasmError<E> {
    fn into_response(self) -> Response {
        let code = match self {
            Self::UnsupportedOption | Self::Unimplemented => StatusCode::NOT_IMPLEMENTED,
            Self::WrongBitWidth(_) => StatusCode::BAD_REQUEST,
